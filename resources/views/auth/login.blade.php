                    ...
                    <form method="POST" action="{{ route('login.submit') }}">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-12 d-flex justify-content-between">
                                ...
                                <a class="btn btn-link" href="{{ route('password.request') }}" style="font-size: 14px;text-decoration:none;margin-left: 5px;color: #2d79f3;font-weight: 500;cursor: pointer;">
