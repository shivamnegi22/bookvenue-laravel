    ...
    <div class="container">
        <div class="row form">
            ...
            <div class="col-md-12  hideForm d-none" id="courtsFormWrapper">
                ...
                <div class="row courtsForm" id="courtsForm">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="inputField" name="courtName[0]" id="courtName" placeholder="Court Name" required />
                    </div>
                    <div class="col-md-4">
                        <div class="d-flex justify-content-between">
                        ...
                        <input type="time" class="inputField" name="startTime[0]" id="startTime" required />
                    </div>
                    <div class="col-md-4">
                        <div class="d-flex justify-content-between">
                        ...
                        <input type="time" class="inputField" name="endTime[0]" id="endTime" required/>
                    </div>
                    <div class="col-md-4 hideForm d-none">
                        <label>Description</label>
            ...
            <div class="col-md-12 d-flex">
                ...
                <button type="submit" class="formButton submit hideForm d-none" name="submit" id="submit_form">Save</button>
            </div>
        </div>
    </div>
</form>
